...
def main():
    ...
    parser.add_argument('--hidden_size', default=256, type=int, help="隐藏层维度（512=Small-26M, 640=MoE-145M, 768=Base-104M）")
    parser.add_argument('--num_hidden_layers', default=24, type=int, help="隐藏层数量（Small/MoE=8, Base=16）") #qhf
    ...
    parser.add_argument('--top_p', default=0.85, type=float, help="nucleus采样阈值（0-1）")
    parser.add_argument('--repetition_penalty', default=1.05, type=float, help="重复惩罚（>1.0为惩罚，越大惩罚越重）") # qhf
